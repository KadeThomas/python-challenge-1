...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Enter the item number you wish to order? ")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items:
                    ...
                    print(f"{menu_selection} is not a valid item number.")
            else:
...
for item in order:
    ...
    price_spaces = 5 - len(f"{item_price:.2f}")
    # 9. Create space strings
    name_spaces_str = " " * name_spaces
    price_space_str = " " * price_spaces

    # 10. Print the item name, price, and quantity
    print(f"{item_name}{name_spaces_str} | ${item_price:.2f}{price_space_str} | {item_quantity}")
